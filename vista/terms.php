...
<html>
    <head>
        <title>Seeking an Job Portal Category Flat Bootstrap Responsive Website Template | Terms :: w3layouts</title>
            ...
            <div class="single">
                <div class="form-container">
                    ...
                    <form>
                        ...
                        <div class="form-group col-md-12">
                            <label class="col-md-3 control-lable" >Horarios De Citas</label>
                            <div class="col-md-6">
