       ...
       <div class="about_middle">
        ...
        <div class="about_bottom">
            ...
            <div class="single">
                ...
                <h2>Datos del empleo</h2>
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class="col-md-3 control-lable" for="tipoCuenta">Empleo</label>
                                <div class="col-md-9">
                                    <select path="tipoCuenta" id="tipoEmpleo" class="form-control input-sm">                                        
                                        ...
                                        <option value="">Ing.Electrico</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class="col-md-3 control-lable" for="tipoCuenta">Horario</label>
                                <div class="col-md-9">
                                    <select path="tipoCuenta" id="tipohorario" class="form-control input-sm">                                        
                                        <option value="">7:00-13:00 hrs</option>
                                        <option value="">8:00-15:00 hrs</option>
                                        <option value="">9:00-19:00 hrs</option>
                                        <option value="">15:00-1:00 hrs</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class="col-md-3 control-lable" for="tipoCuenta">Dias laborales</label>
                                <div class="col-md-9">
                                    <select path="tipoCuenta" id="tiposalario" class="form-control input-sm">                                        
                                        <option value="">Lunes-Viernes</option>
                                        <option value="">Lunes-Sabado</option>
                                        <option value="">Martes-Domingo</option>
                                    </select>
                ...
                <div class="row">
                            <div class="form-group col-md-12">
                                <label class="col-md-3 control-lable" for="tipoCuenta">Salario</label>
                                <div class="col-md-9">
                                    <select path="tipoCuenta" id="tiposalario" class="form-control input-sm">                                        
                ...
                <div class="row">
                            <div class="form-actions floatRight">
                                <input type="submit" value="Publicar" class="btn btn-primary btn-sm">
                            </div>
                        </div>
                </div> 
            </div>
